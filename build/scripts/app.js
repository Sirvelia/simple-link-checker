...
/***/ "./resources/scripts/data/inboundLinks.ts":
/*!************************************************!*\
  !*** ./resources/scripts/data/inboundLinks.ts ***!
  \************************************************/
...
/* harmony export */   "default": () => (/* binding */ inboundLinks)
/* harmony export */ });
...
function inboundLinks() {
  document.addEventListener('alpine:init', () => {
    alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('inboundLinks', () => ({
      links: [],
      async init() {
        this.links = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
...
/***/ "./resources/scripts/data/outboundLinks.ts":
/*!*************************************************!*\
  !*** ./resources/scripts/data/outboundLinks.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ outboundLinks)
/* harmony export */ });
/* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/module.esm.js");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/api-fetch */ "@wordpress/api-fetch");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1__);
...
const COMPATIBLE_BLOCKS = ['core/paragraph', 'core/heading', 'core/list', 'core/quote', 'core/buttons', 'core/columns', 'core/group'];

// Main function to set up outbound links functionality
function outboundLinks() {
  document.addEventListener('alpine:init', () => {
    alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('outboundLinks', () => ({
      blocks: [],
      links: [],
      ...
      updateBlocks() {
        ...
        this.blocks = blocks.map(block => this.createBlockData(getBlock(block.clientId))).filter(block => block !== null);
      },
      ...
      getBlockLinks(block, content) {
        if (!content) return [];
        const doc = new DOMParser().parseFromString(content, 'text/html');
        return Array.from(doc.querySelectorAll('a')).map((link, index) => this.createLinkData(block.clientId, link, index));
      },
      // Create a Link object from an HTML anchor element
      createLinkData(blockId, link, index) {
        return {
          id: `${blockId}/${index}`,
          href: link.href,
      ...
      toggleNoFollow() {
        ...
        const block = getBlock(blockId);
        if (block) {
          const updatedContent = this.updateLinkAttribute(getBlockAttributes(blockId).content, 'rel', 'nofollow', this.$data.link.noFollow);
          updateBlockAttributes(blockId, {
            content: updatedContent
          });
        }
      ...
      toggleTargetBlank() {
        ...
        const block = getBlock(blockId);
        if (block) {
          const updatedContent = this.updateLinkAttribute(getBlockAttributes(blockId).content, 'target', '_blank', this.$data.link.targetBlank);
          updateBlockAttributes(blockId, {
            content: updatedContent
          });
        }
      ...
      updateLinkAttribute(content, attribute, value, shouldAdd) {
        const doc = new DOMParser().parseFromString(content, 'text/html');
        const links = doc.querySelectorAll('a');
        const linkToUpdateIndex = parseInt(this.$data.link.id.split('/')[1]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/module.esm.js");
/* harmony import */ var _data_outboundLinks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data/outboundLinks */ "./resources/scripts/data/outboundLinks.ts");
/* harmony import */ var _data_inboundLinks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data/inboundLinks */ "./resources/scripts/data/inboundLinks.ts");



window.addEventListener('DOMContentLoaded', () => {
  (0,_data_outboundLinks__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_data_inboundLinks__WEBPACK_IMPORTED_MODULE_2__["default"])();
