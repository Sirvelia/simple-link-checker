<div x-data="{editedLink: link.href}" class="slc-overflow-hidden slc-rounded-lg slc-bg-white slc-shadow">
    <div class="slc-px-2 slc-py-3 sm:slc-p-2">
        ...
        <div class="slc-relative slc-flex slc-items-start">
            <div class="slc-flex slc-h-6 slc-items-center">
                <input :id="`noFollow-{link.id}`" :name="`noFollow-{link.id}`" type="checkbox" class="slc-m-0 slc-h-4 slc-w-4 slc-rounded slc-border-gray-300 slc-text-indigo-600 focus:slc-ring-indigo-600" x-model="link.noFollow" @change.debounce.500ms="toggleNoFollow()">
            </div>
